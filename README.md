...
Uma lista de ferramentas e recursos de OSINT (Open-source intelligence). OSINT é uma das fontes de inteligência que está disponível para todas as pessoas, pelo fato das informações serem públicas. 
...
* [Tor Browser](https://www.torproject.org/projects/torbrowser.html.en) - O Tor é um software gratuito que impede que as pessoas aprendam sua localização ou hábitos de navegação, permitindo que você se comunique anonimamente na Internet.
